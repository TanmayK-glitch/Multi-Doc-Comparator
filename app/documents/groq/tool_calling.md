...
## [How Local Tool Calling Works](https://console.groq.com/docs/tool-use/local-tool-calling#how-local-tool-calling-works)
...
## [The Three Components of Local Tool Calling](https://console.groq.com/docs/tool-use/local-tool-calling#the-three-components-of-local-tool-calling)

To implement local tool calling, you need to provide three components:

### [1. Tool Schema (Definition)](https://console.groq.com/docs/tool-use/local-tool-calling#1-tool-schema-definition)
...
### [2. Tool Implementation (Function)](https://console.groq.com/docs/tool-use/local-tool-calling#2-tool-implementation-function)
...
### [3. Orchestration (The Loop)](https://console.groq.com/docs/tool-use/local-tool-calling#3-orchestration-the-loop)
...
## [Complete Example: Calculator Tool](https://console.groq.com/docs/tool-use/local-tool-calling#complete-example-calculator-tool)
...
## [Parallel Tool Use](https://console.groq.com/docs/tool-use/local-tool-calling#parallel-tool-use)
...
## [Complete Multi-Tool Example with Agentic Loop](https://console.groq.com/docs/tool-use/local-tool-calling#complete-multitool-example-with-agentic-loop)
...
## [Controlling Tool Use Behavior](https://console.groq.com/docs/tool-use/local-tool-calling#controlling-tool-use-behavior)

The `tool_choice` parameter controls how the model uses tools:

### [`tool_choice: "auto"`](https://console.groq.com/docs/tool-use/local-tool-calling#toolchoice-auto-default)[ (Default)](https://console.groq.com/docs/tool-use/local-tool-calling#toolchoice-auto-default)
...
### [`tool_choice: "required"`](https://console.groq.com/docs/tool-use/local-tool-calling#toolchoice-required)
...
### [`tool_choice: "none"`](https://console.groq.com/docs/tool-use/local-tool-calling#toolchoice-none)
...
### [`tool_choice: {"type": "function", "function": {"name": "function_name"}}`](https://console.groq.com/docs/tool-use/local-tool-calling#toolchoice-type-function-function-name-functionname)
...
## [Streaming Tool Use](https://console.groq.com/docs/tool-use/local-tool-calling#streaming-tool-use)
...
## [Structured Outputs with Type Safety](https://console.groq.com/docs/tool-use/local-tool-calling#structured-outputs-with-type-safety)

For more complex tools with strict schema requirements, we recommend using type-safe libraries:

### [Python: Instructor](https://console.groq.com/docs/tool-use/local-tool-calling#python-instructor)
...
### [TypeScript: Zod](https://console.groq.com/docs/tool-use/local-tool-calling#typescript-zod)
...
## [Error Handling](https://console.groq.com/docs/tool-use/local-tool-calling#error-handling)
...
### [Groq's Tool Call Validation](https://console.groq.com/docs/tool-use/local-tool-calling#groqs-tool-call-validation)
...
### [Retry Strategy for Failed Tool Calls](https://console.groq.com/docs/tool-use/local-tool-calling#retry-strategy-for-failed-tool-calls)
...
### [Handle Missing Tool Calls](https://console.groq.com/docs/tool-use/local-tool-calling#handle-missing-tool-calls)
...
### [Handle Tool Execution Errors](https://console.groq.com/docs/tool-use/local-tool-calling#handle-tool-execution-errors)
...
### [Validate Tool Call Arguments](https://console.groq.com/docs/tool-use/local-tool-calling#validate-tool-call-arguments)
...
### [Complete Error Handling Example](https://console.groq.com/docs/tool-use/local-tool-calling#complete-error-handling-example)
...
## [Best Practices](https://console.groq.com/docs/tool-use/local-tool-calling#best-practices)

### [1. Write Clear Tool Descriptions](https://console.groq.com/docs/tool-use/local-tool-calling#1-write-clear-tool-descriptions)
...
### [2. Use Descriptive Parameter Names](https://console.groq.com/docs/tool-use/local-tool-calling#2-use-descriptive-parameter-names)
...
### [3. Return Structured Data](https://console.groq.com/docs/tool-use/local-tool-calling#3-return-structured-data)
...
### [4. Limit Tool Count](https://console.groq.com/docs/tool-use/local-tool-calling#4-limit-tool-count)
...
### [5. Use System Prompts Effectively](https://console.groq.com/docs/tool-use/local-tool-calling#5-use-system-prompts-effectively)
...
## [Next Steps](https://console.groq.com/docs/tool-use/local-tool-calling#next-steps)
